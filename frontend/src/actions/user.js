...
export const addBlog =
  (title, image, description, question, option1, option2, option3, option4, answer ) => async (dispatch) => {
    try {
      dispatch({
      ...
      const { data } = await axios.post(
        ...
        { title, image, description, question, option1, option2, option3, option4, answer },
        {
          headers: {
            "Content-Type": "application/json",
          },
  ...
  (question, option1, option2, option3, option4, answer, id ) => async (dispatch) => {
    try {
      dispatch({
